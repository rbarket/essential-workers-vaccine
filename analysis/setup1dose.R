...
u_var <- c(0.38, 0.4, 0.79, 0.86, 0.8, 0.82, 0.88, 1.0, 1.0, 
                 0.4, 0.79, 0.86, 0.8, 0.82, 1.0, 1.0, 1.0) # rel. susceptibility (this works better with validation than one in bubar)
...
strategies <- list(list(9,c(8,15),c(7,14), c(6,13), c(5,12), c(4,11), c(3,10)), # this isnt needed, we already assuming pop. is vaccinated
                   list(9,3:15),
