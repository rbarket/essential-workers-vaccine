...
run_sim_basic = function(C, I_0, percent_vax, strategy, num_perday, v_e, v_p,
                       u = u_var, num_days=365,H=rep(0,num_groups), 
                        one_dose=TRUE,set_vax_prop=NULL,p_grp=NULL){
  ...
  df <- add_names(df, one_dose)

  return(df)
}


add_names = function(df, one_dose){
  if (one_dose){

    names(df) <- c("time", "S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9",
                  "Se2", "Se3", "Se4", "Se5", "Se6", "Se7", "Se8", "Se9",
                 "Sv1", "Sv2", "Sv3", "Sv4", "Sv5", "Sv6", "Sv7", "Sv8", "Sv9",
                  "Sve2","Sve3", "Sve4", "Sve5", "Sve6", "Sve7", "Sve8", "Sve9",
                 "Sx1", "Sx2", "Sx3", "Sx4", "Sx5", "Sx6", "Sx7", "Sx8", "Sx9",
                  "Sxe2","Sxe3", "Sxe4", "Sxe5", "Sxe6", "Sxe7", "Sxe8", "Sxe9",
                 "E1", "E2", "E3", "E4", "E5", "E6", "E7", "E8", "E9",
                  "Ee2","Ee3", "Ee4", "Ee5", "Ee6", "Ee7", "Ee8", "Ee9",
                 "Ev1", "Ev2", "Ev3", "Ev4", "Ev5", "Ev6", "Ev7", "Ev8", "Ev9",
                   "Eve2","Eve3", "Eve4", "Eve5", "Eve6", "Eve7", "Eve8","Eve9",
                 "Ex1", "Ex2", "Ex3", "Ex4", "Ex5", "Ex6", "Ex7", "Ex8", "Ex9",
                 "Exe2", "Exe3", "Exe4", "Exe5", "Exe6", "Exe7", "Exe8","Exe9",
                 "I1", "I2", "I3", "I4", "I5", "I6", "I7", "I8", "I9",
                 "Ie2", "Ie3", "Ie4", "Ie5", "Ie6", "Ie7", "Ie8","Ie9",
                 "Iv1", "Iv2", "Iv3", "Iv4", "Iv5", "Iv6", "Iv7", "Iv8", "Iv9",
                 "Ive2", "Ive3", "Ive4", "Ive5", "Ive6", "Ive7", "Ive8","Ive9", 
                 "Ix1", "Ix2", "Ix3", "Ix4", "Ix5", "Ix6", "Ix7", "Ix8", "Ix9",
                  "Ixe2","Ixe3", "Ixe4", "Ixe5", "Ixe6", "Ixe7", "Ixe8","Ixe9",
                 "R1", "R2", "R3", "R4", "R5", "R6", "R7", "R8", "R9",
                  "Re2","Re3", "Re4", "Re5", "Re6", "Re7", "Re8","Re9",
                 "Rv1", "Rv2", "Rv3", "Rv4", "Rv5", "Rv6", "Rv7", "Rv8", "Rv9",
                   "Rve2","Rve3", "Rve4", "Rve5", "Rve6", "Rve7", "Rve8","Rve9", 
                 "Rx1", "Rx2", "Rx3", "Rx4", "Rx5", "Rx6", "Rx7", "Rx8", "Rx9",
                    "Rxe2","Rxe3", "Rxe4", "Rxe5", "Rxe6", "Rxe7", "Rxe8", "Rxe9",
...
run_sim_ramp_R = function(C, I_0, R_vec, percent_vax, strategy, num_perday, v_e, v_p,
                       u = u_var, num_days=365,H=rep(0,num_groups), 
                        one_dose=TRUE,set_vax_prop=NULL,p_grp=NULL){
  # add R as vector 
  if (!is.list(strategy)){
...
get_R_vec <- function(R1, R2, start_ramp, end_ramp, ndays) {
  ...
  # linear ramp from start_ramp to end_ramp
  if (R2 == R1){
    R_vec <- rep(R1, ndays)
  } else if (R2 > R1){
    R_vec <- c(rep(R1,start_ramp), 
      seq(from=R1, to=R2, by=(R2-R1)/(end_ramp-start_ramp-1)), 
      rep(R2,ndays-end_ramp))
  } else if (R2 < R1){
    R_vec <- c(rep(R1,start_ramp), 
      rev(seq(from=R1, to=R2, by=(R2-R1)/(end_ramp-start_ramp-1))), 
      rep(R2,ndays-end_ramp))
  }
